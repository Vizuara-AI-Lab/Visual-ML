...
export const mlAlgorithmsCategory: NodeCategory = {
  ...
  nodes: [
...

    {
      ...
      configFields: [
        ...
        },
        {
          ...
          type: "checkbox",
          defaultValue: false,
          description: "Toggle advanced hyperparameters",
        },
        {
          name: "weights",
          ...
          options: [
            ...
            { value: "distance", label: "Distance-weighted" },
          ],
        ...
        },
        {
          ...
          description: "Distance measure between points",
          conditionalDisplay: { field: "show_advanced_options", equals: true },
        },
        {
          name: "p",
...

    {
      ...
      configFields: [
        ...
        },
        {
          ...
          defaultValue: "rbf",
          description: "Kernel function for decision boundary",
        },
        {
          name: "C",
          ...
          max: 100,
          step: 0.1,
          description: "Trade-off between margin width and errors",
        },
        {
          name: "show_advanced_options",
          label: "Show Advanced Options",
        ...
        },
        {
          ...
          type: "select",
          options: [
            { value: "scale", label: "Scale (recommended)" },
    ...
    // Unsupervised Algorithms
    {
      ...
      description: "Unsupervised clustering to discover groups in data",
      category: "ml-algorithms",
      icon: Brain,
      color: "#06B6D4",
      defaultConfig: {
      ...
      configFields: [
        {
          ...
          required: true,
          autoFill: true,
          description: "Auto-filled from connected split or data node",
        },
        {
          ...
          required: false,
          defaultValue: "",
          description: "Comma-separated column names to exclude (e.g. 'id, name')",
        },
        {
          name: "n_clusters",
        ...
        },
        {
          ...
          type: "select",
          options: [
            { value: "k-means++", label: "K-Means++ (recommended)" },
        ...
        },
        {
          ...
          min: 1,
          max: 50,
          description: "Run K-Means N times, keep the best result",
          conditionalDisplay: { field: "show_advanced_options", equals: true },
        },
        {
          name: "random_state",
