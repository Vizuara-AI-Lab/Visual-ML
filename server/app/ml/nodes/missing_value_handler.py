...
class MissingValueHandlerInput(NodeInput):
    ...
    default_strategy: str = Field(
        "none", 
        description="Default strategy for columns not in column_configs"
    )
    
    # Preview mode
    preview_mode: bool = Field(
        False, 
        description="If true, return preview without saving changes"
    )
    ...
    operation_id: Optional[str] = Field(
        None, 
        description="Operation ID for tracking (auto-generated if not provided)"
    )
    ...
    def validate_default_strategy(cls, v: str) -> str:
        ...
        valid_strategies = ["drop", "mean", "median", "mode", "fill", "forward_fill", "backward_fill", "none"]
...
class MissingValueHandlerOutput(NodeOutput):
    ...
    preview_data: Optional[Dict[str, Any]] = Field(
        None, 
        description="Before/after preview data"
    )
    ...
    def _generate_preview(
        ...
        for idx in valid_indices:
            ...
            for col in df_before.columns:
                ...
                if (is_nan_before != is_nan_after) or (not is_nan_before and not is_nan_after and val_before != val_after):
