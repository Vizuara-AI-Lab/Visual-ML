...
class SystemPromptNode(PromptNode):
    """
    System Prompt Node - adds system instruction.

    Config:
        systemRole: Role description (e.g., "helpful assistant")
    ...
    async def _execute_genai(self, input_data: GenAINodeInput) -> GenAINodeOutput:
        ...
        system_role = self.config.get("systemRole", "helpful assistant")
        ...
        system_content = f"You are a {system_role}. {system_prompt}"
